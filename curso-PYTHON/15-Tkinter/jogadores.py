...
clube=["Manchester",	"Juventus",	"Liverpool",	"Newcastle",	"Real Madrid",	"Barcelona",	"Palmeiras",	"Juventus",	"Real Madrid",	"Manchester",	"Liverpool",	"Manchester",	"Arsenal",	"Atlético-MG"	,"Lyon",	"PSG"	,"PSG",	"Aston Villa",	"Leeds United",	"Everton",	"Real Madrid",	"Chelsea",	"Real Madrid",	"Palmeiras"]
país = ["Inglaterra","Itália","Inglaterra","Inglaterra","Espanha","Espanha","Brasil","Itália","Espanha","Inglaterra","Inglaterra","Inglaterra","Inglaterra","Brasil","França","França","França","Inglaterra","Inglaterra","Inglaterra","Espanha","Inglaterra","Espanha","Brasil"]
salario= [2.7,	2.4,	5.1,	2.5,	5.1,	0.98,	0.5,	2.2,	4.2,	4.3,	4.1,	3.4,	0.95,	0.45,	4.5	,7.1,	22,	9.5,	4.1,	2.5,	3.5,	2.8,	5.5,	0.3]
